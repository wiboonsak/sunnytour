            ...
            $.ajax({
                ...
                success: function (data, status) {
                    ...
                    if (status == 'success') {
                        ...
                        setTimeout(function () {
                            window.location.href = "<?php echo base_url('PackageCMS/category_abroad') ?>" ;
                        }, 1000);
                    } else {
                        swal({
		 ...
		 if((changeValue=='')){
			...
			$.post('<?php echo base_url('PackageCMS/updateOrderCate')?>',{ dataID:dataID , FieldName:FieldName , changeValue:changeValue }
				  ,function(data){ 
                    ...
                    setTimeout(function(){ window.location.href = "<?php echo base_url('PackageCMS/category_abroad')?>"; }, 1000);
