        ...
        <div class="container-fluid">
            ...
            <div class="card-box">									<div id="showData">
                            <div class="pull-right">
                                <button type="button" class="btn btn-success btn-sm" onClick="window.location.href = '<?php echo base_url('PackageCMS/packageAddLocal') ?>'"><i class="fa fa-plus"></i> Add Package</button>
                            </div>
                            <table id="table2" class="table table-hover">
                                ...
                                <tbody>
 <?php $n = 1; 
  $packageData =$this->Package_model->list_packageData('1');
    foreach ($packageData->result() AS $Data) {?>	
                                        <tr id="row<?php echo $Data->id ?>">
                                            ...
                                            <td style="text-align:center;" ><button type="button" class="btn btn-success btn-sm" onClick="window.location.href = '<?php echo base_url('PackageCMS/packageAddLocal/' . $Data->id) ?>'"><i class="icon-pencil"></i></button></td>
