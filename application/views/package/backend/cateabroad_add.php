            ...
            <ul class="list-inline menu-left mb-0">
                ...
                <li>
                    <div class="page-title-box">
                        <h4 class="page-title">Category Abroad</h4>
                    </div>
                </li>
            </ul>
        </nav>
    ...
    <div class="content">
        <div class="container-fluid">
            ...
            <div class="card-box">
                <?php 
if ($currentID != '') {
    $placeData = $this->Package_model->list_cateabroadData('2',$currentID);
...
?>
              <form enctype="multipart/form-data" id="CateForm" name="CateForm">
                <div class="form-group row">
                    <label class="col-sm-3 col-form-label">Cate Abroad :</label>
                    <div class="col-sm-9">
