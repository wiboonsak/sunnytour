...
">
<div class="line-it-button" data-lang="en" data-type="share-a" data-ver="3" data-url="<?php echo base_url('Tour/package_Detail/').$Dataid?>" data-color="default" data-size="small" data-count="false" style="display: none;"></div>
             </div>
             </div>
	</div>
	  <!--end item-->
	  ...
	  <div class="col-md-7">
		...
		<p>  <a class="btn btn-medium btn-orange btn-anim-2 uppercase" href="#time_table"><i class="fa fa-pencil" aria-hidden="true"></i> <span>จองแพ็คเกจทัวร์</span></a></p>
	  </div>
	  <!--end item-->
...
<!--						  <iframe width="48%" height="300" src="https://www.youtube.com/embed/vbhGBeVJjn4" frameborder="0" allowfullscreen></iframe>			 
    ...
    <div class="clearfix"></div>
		...
		<iframe src="../../../../HTML/table.html" width="100%" height="500"></iframe>
	...
	<section class="sec-padding section-light" style="margin-top: 20px" >
	  ...
	  <div class="col-md-12">
	   <div class="card-box table-responsive">
               ...
               <div class="col-md-4" style="background-color: #E5E5E5; text-align: center;color: black;font-weight: bold;"><br>วันเดินทาง<br>&nbsp;&nbsp;</div>
               <div class="col-md-2" style="background-color: #E5E5E5; text-align: center;color: black;font-weight: bold;"><br>ผู้ใหญ่<br>(พัก 2-3 ท่าน)</div>
               <div class="col-md-2" style="background-color: #E5E5E5; text-align: center;color: black;font-weight: bold;"><br>ผู้ใหญ่<br>(พักเดี่ยว)</div>
               <div class="col-md-2" style="background-color: #E5E5E5; text-align: center;color: black;font-weight: bold;"><br>เด็ก<br>(ไม่เพิ่มเตียง)</div>
               <div class="col-md-2" style="background-color: #E5E5E5; text-align: center;color: black;font-weight: bold;"><br>เด็ก<br>(เพิ่มเตียง)</div>
                 </div>
               <div class="col-md-2 " style="padding:0px">
               <div class="col-md-12" style="background-color: #E5E5E5; text-align: center;color: black;font-weight: bold;"><br>&nbsp;&nbsp;<br>&nbsp;</div>
               </div>
            <?php $n = 1;
        foreach ($option->result() as $option2) { ?>
               <div class="col-md-10" style="padding:0px">
                   <div class="col-md-4" ><h6><i class="fa fa-calendar"></i>&nbsp;&nbsp; <?php echo $option2->Traveling_date ?></h6></div>
               <div class="col-md-2" style="text-align: center"><h6><?php echo number_format($option2->adult_price) ?> บาท</h6></div>
               <div class="col-md-2" style="text-align: center"><h6><?php echo number_format($option2->aloneadult_price) ?> บาท</h6></div>
               <div class="col-md-2" style="text-align: center"><h6><?php echo number_format($option2->child_price) ?> บาท</h6></div>
               <div class="col-md-2" style="text-align: center"><h6><?php echo number_format($option2->addchild_price) ?> บาท</h6></div>
               </div>
               <div class="col-md-2" style="padding:0px">
               <div class="col-md-12" onclick="bookdetail('<?php echo number_format($option2->adult_price) ?>','<?php echo number_format($option2->aloneadult_price)?>','<?php echo number_format($option2->child_price)?>','<?php echo number_format($option2->addchild_price)?>','<?php echo $option2->adult_price?>','<?php echo $option2->aloneadult_price?>','<?php echo $option2->child_price?>','<?php echo $option2->addchild_price?>','<?php echo $option2->id?>')" style="text-align: center"><a class="btn btn-small btn-orange btn-anim-2 uppercase" href="#book_detail"><i class="fa fa-pencil" aria-hidden="true"></i> <span>จองทัวร์</span></a></div>
               </div>
               <?php }?>  
	...
	<section class="sec-padding section-light" style="margin-top: 20px" >
	  ...
	  <div class="col-md-12">
	   <div class="table-responsive">
               <div class="col-md-3" style="background-color: #E5E5E5; text-align: center;color: black;font-weight: bold;"><br>ประเภทห้อง<br>&nbsp;&nbsp;</div>
               <div class="col-md-3" style="background-color: #E5E5E5; text-align: center;color: black;font-weight: bold;"><br>ราคา/คน<br>&nbsp;&nbsp;</div>
               <div class="col-md-3" style="background-color: #E5E5E5; text-align: center;color: black;font-weight: bold;"><br>จำนวนผู้เดินทาง<br>&nbsp;&nbsp;</div>
               <div class="col-md-3" style="background-color: #E5E5E5; text-align: center;color: black;font-weight: bold;"><br>ราคา/คน<br>&nbsp;&nbsp;</div>
               
               <div class="col-md-3" ><h6><i class="fa fa-calendar"></i>&nbsp;&nbsp; ผู้ใหญ่ (พัก 2-3 ท่าน)</h6></div>
               <div class="col-md-3" style=" text-align: center;"><h6><span id="ad1">0</span> บาท</h6></div>
               <div class="col-md-3" style=" text-align: center;padding-top: 10px"><input class="form-control text-center" type="number"  id="people1" name="people1" onchange="changepeople1(this.value)"></div>
               <div class="col-md-3" style=" text-align: center;"><h6><span id="ad2">0</span> บาท</h6></div>
                
         <br>
               <div class="col-md-3" ><h6><i class="fa fa-calendar"></i>&nbsp;&nbsp; ผู้ใหญ่ (พักเดี่ยว)</h6></div>
               <div class="col-md-3" style=" text-align: center;"><h6><span id="alone1">0</span> บาท</h6></div>
               <div class="col-md-3" style=" text-align: center;padding-top: 10px"><input class="form-control text-center" type="number"  id="people2" name="people2" onchange="changepeople2(this.value)"></div>
               <div class="col-md-3" style=" text-align: center;"><h6><span id="alone2">0</span> บาท</h6></div>
               
          
               <div class="col-md-3" ><h6><i class="fa fa-calendar"></i>&nbsp;&nbsp; เด็ก (ไม่เพิ่มเตียง)</h6></div>
               <div class="col-md-3" style=" text-align: center;"><h6><span id="child1">0</span> บาท</h6></div>
               <div class="col-md-3" style=" text-align: center;padding-top: 10px"><input class="form-control text-center" type="number"  id="people3" name="people3" onchange="changepeople3(this.value)"></div>
               <div class="col-md-3" style=" text-align: center;"><h6><span id="child2">0</span> บาท</h6></div>
               
               
               <div class="col-md-3" ><h6><i class="fa fa-calendar"></i>&nbsp;&nbsp; เด็ก (เพิ่มเตียง)</h6></div>
               <div class="col-md-3" style=" text-align: center;"><h6><span id="childextra1">0</span> บาท</h6></div>
               <div class="col-md-3" style=" text-align: center;padding-top: 10px"><input class="form-control text-center" type="number"  id="people4" name="people4" onchange="changepeople4(this.value)"></div>
               <div class="col-md-3" style=" text-align: center;"><h6><span id="childextra2">0</span> บาท</h6></div>
               
               
               <div class="col-md-3" style=" text-align: center;">&nbsp;</div>
               <div class="col-md-3" style=" text-align: center;">&nbsp;</div>
               <div class="col-md-3" style=" text-align: center;"><h6>รวม <span id="totalpeople"></span>  ท่าน </h6> 
                   <input type="hidden" id="totalpeople1" name="totalpeople1"/></div>
               <div class="col-md-3" style=" text-align: center;"><h5 style="color: #CF0104; font-weight: 600"><span id="total1">0</span> บาท</h5>
	  ...
	  <!--end item-->
		  ...
		  2. ผู้เดินทางที่ต้องการพักเดี่ยว มีค่าใช้จ่ายเพิ่มท่านละ 6000.0 บาท<br>
	...
	<section class="sec-padding section-light" style="margin-top: 20px" >
	  ...
	  <div class="col-md-12">
		  ...
		  <div class="col-xs-12 padding">
                      <textarea class="textaria-1" id="comment" name="comment" type="text" class="textaria-1" placeholder="ความต้องการเพิ่มเติมอื่นๆ"></textarea>			   
		  </div>
		  <div class="col-xs-12 padding">
	...
	<section class="sec-padding section-light" style="margin-top: 20px" >
	  ...
	  <div class="col-md-12">
		  ...
		  <div class="col-xs-12 padding">
              ...
              <input class="sp-binfo" type="date"  id="datestart" name="datestart" placeholder="วันที่เดินทางไป">
          </div>
              <div class="col-xs-2 padding test">
...
function bookdetail(adult_price,aloneadult_price,child_price,addchild_price,adult_price1,aloneadult_price1,child_price1,addchild_price1,optionid){
    var total = parseInt(adult_price1)+parseInt(aloneadult_price1)+parseInt(child_price1)+parseInt(addchild_price1);
